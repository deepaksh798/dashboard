...
const CreateNewAssistant = ({ open, onClose, afterSubmit }: Props) => {
  ...
  return (
    <Dialog open={open} onOpenChange={handleCloseDialog}>
      <DialogContent className="no-scrollbar flex flex-col items-center justify-center rounded-lg text-white bg-[#414141] border-none max-w-[700px] h-[90vh] overflow-auto">
        <DialogHeader>
